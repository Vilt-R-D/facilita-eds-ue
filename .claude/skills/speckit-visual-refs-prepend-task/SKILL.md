---
name: speckit-visual-refs-prepend-task
description: Prepend a visual-context task to tasks.md based on spec.md **Input**
  line
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: visual-refs:commands/speckit.visual-refs.prepend-task.md
---
