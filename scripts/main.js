  ...
  function applyBehaviours() {
    ...
    waitForElement('.swiper-container', () => {
      loadJS(`${window.hlx.codeBasePath}/scripts/swiper-bundle.js`, () => {
        initSwiper();
        document.querySelector('.swiper-button-prev')?.setAttribute('aria-label', 'Voltar Carrossel');
        document.querySelector('.swiper-button-next')?.setAttribute('aria-label', 'Avançar Carrossel');
      }, document.body);
    });
